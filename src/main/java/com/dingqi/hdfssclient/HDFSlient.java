package com.dingqi.hdfssclient;
...
public class HDFSlient {

    private FileSystem fs;

    @Before
    public void before() throws IOException, InterruptedException {
        fs = FileSystem.get(URI.create("hdfs://hadoop131:9011"), new Configuration(), "dingqi");
...
//        configuration.setInt("dfs.replication",1);
    ...
    public void get() throws IOException, InterruptedException {
        ...
        //获取一个HDFS的抽象封装对象
        Configuration configuration = new Configuration();
        FileSystem fileSystem = FileSystem.get(URI.create("hdfs://hadoop131:9011"),
                configuration, "dingqi");

        //用这个对象操作文件系统
        fileSystem.copyToLocalFile(new Path("/wcinput"), new Path("G:\\"));
